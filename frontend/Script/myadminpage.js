...
async function deleteproduct(id) {
    let res = await fetch(`http://localhost:9090/product/delete/${id}`,
        {
            method: "DELETE",
...
addProduct.addEventListener("click", () => {
    ...
    productform.addEventListener("submit", async (e) => {
        ...
        let res = await fetch("http://localhost:9090/product/create",
            {
                method: "POST",
                headers: {
...
userBtn.addEventListener("click", async () => {
    ...
    let res = await fetch("http://localhost:9090/user")
    let data = await res.json()
    console.log(data)
...
orderBtn.addEventListener("click", async () => {
    ...
    let res = await fetch("http://localhost:9090/order")
    let data = await res.json()
    console.log(data)
